	...
	render() {
		return (
			<div>
				...
				<p>I’m concerned about net neutrality. Millions of people spoke out for the strong net neutrality rules we currently have because they protect us from ISPs like Comcast and Verizon that want to block, throttle, and charge us extra fees to access information equally online.</p>
